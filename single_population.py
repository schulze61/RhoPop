...
if __name__ == '__main__':
    with dynesty.pool.Pool(cpu_count(), loglike, ptform) as pool:
        ...
        if dynesty_plots == True:
            dynesty_plotting.continuum.runplot(results, froot = dfile_root)
            dynesty_plotting.continuum.corner(results, froot = dfile_root)
            dynesty_plotting.continuum.traceplot(results, froot = dfile_root)
